...
run_ei() {
  ...
  # Link izin IP VPS
  url_izin='https://raw.githubusercontent.com/myzid/regina/main/izin.txt'
...
clear
      ...
      echo -e ""
      echo -e "\e[93m Telegram\e[32;1m : https://t.me/×××"
      echo -e "\e[33m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | lolcat
      echo -e ""
      exit 0
    fi
...
rm -fr menu
rm -fr /usr/sbin/menu
wget https://raw.githubusercontent.com/myzid/regina/main/menu.zip
unzip menu.zip
chmod +x menu/*
...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/myzid/regina/main/password"
...
wget -O /etc/nginx/conf.d/xray.conf https://raw.githubusercontent.com/myzid/regina/main/xray.conf
...
wget -O /etc/xray/config.json https://raw.githubusercontent.com/myzid/regina/main/config.json
